...
const epubChapters = [
  ...
  }),
  {
    ...
    content: `
      ...
      <p><strong>November 24, 1971 — 5:46 p.m.</strong> — Flight 305 lands at Seattle-Tacoma International Airport. Ransom money (10,000 recorded-serial-number twenties) and four parachutes are delivered. All 36 passengers are released unharmed.</p>
      <p><strong>November 24, 1971 — 7:40 p.m.</strong> — The aircraft takes off from Seattle heading south toward Reno, with Cooper specifying flaps at 15°, landing gear down, altitude at 10,000 feet, airspeed no more than 200 knots, and cabin unpressurised.</p>
      <p><strong>November 24, 1971 — 8:13 p.m.</strong> — The aircraft's tail section suddenly pitches upward. The aft airstair warning light illuminates. Cooper has jumped from the rear of the aircraft into freezing rain and total darkness somewhere over southwest Washington.</p>
      ...
      <p><strong>April 7, 1972</strong> — Richard Floyd McCoy Jr. hijacks United Airlines Flight 855 (Newark to Los Angeles), boarding during a Denver stopover, using Cooper's exact method — rear airstair parachute jump with $500,000 in ransom. He is arrested two days later. The FBI considers and rejects him as Cooper.</p>
