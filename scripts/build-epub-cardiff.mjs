...
const epubChapters = [
  ...
  }),
  {
    ...
    content: `
      ...
      <p><strong>1868 (November)</strong> — The completed figure is shipped by rail to Cardiff, New York, and buried behind the barn of Hull's distant relative, William "Stub" Newell, on a cold night. Total cost of the project: $2,600.</p>
      ...
      <p><strong>1876</strong> — Hull, broke after bad investments, attempts a second hoax with a "Colorado Giant" made of clay, ground bones, rock dust, and plaster. It fails quickly.</p>
